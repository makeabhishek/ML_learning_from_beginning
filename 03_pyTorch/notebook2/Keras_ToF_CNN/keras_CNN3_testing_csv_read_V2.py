# For testing multiple trainign data
...
csvFilenames = []
diametermix = []
testDatFileName = 'filename_testData_random_90%_11012024_test1.csv'
...
for jj in range (numFiles):
    diametermix = []
    modelFile = "c_training_data_Rec_7to11_Din_random_60%_11012024_test1"
    # modelFile = "c_training_data_Rec_7to11_Din_random_10%_10242023_test" + str(jj+1)
